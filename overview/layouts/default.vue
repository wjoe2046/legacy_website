    ...
    <v-content>
      ...
      <v-footer color="#A2C5BF" :elevation="6">
        ...
        >
          ...
          <v-card-text>
            <a style="margin-right:100px;" href="https://www.facebook.com/CovidWatch2020" target="_blank">
              <img style="width: 5em;" src="~/assets/images/footer_assets/facebook-white.png" alt="Like us on Facebook" />
            </a>
            <a href="https://twitter.com/COVIDWatchApp" target="_blank">
              <img style="width: 5em;" src="~/assets/images/footer_assets/twitter-white.png" alt="Like us on Twitter" />
            </a>
          </v-card-text>
          <v-card-text class="gray--text">
            Licensed
