      ...
      <v-col cols="12" lg="10">
        <section class="text-content">
          <div class="container">
            ...
            <p>
                After discussions with Covid Watch and our partner organizations, Apple and Google <a href="https://www.apple.com/newsroom/2020/04/apple-and-google-partner-on-covid-19-contact-tracing-technology/">announced</a> today that they are working together for the first time on a protocol that will alert users if they have been exposed to the coronavirus.
            </p>

            <p>
              The <a href="https://www.apple.com/covid19/contacttracing/">specifications</a> for their APIs, to be released in May, make it clear that the standard going forward for digital contact tracing will respect privacy.
            </p>
            ...
            <p>
              Many open-source contact tracing efforts have converged on this privacy-focused contact alert system, leading to the formation of the <a href="https://tcn-coalition.org/">TCN Coalition</a>. 
            </p>
            ...
            <p>
              Oxford university epidemiologists recently showed that <a href="https://science.sciencemag.org/content/early/2020/04/09/science.abb6936">digital contact tracing</a> could play a critical role in enabling regions to come out of lockdowns. If 60 percent of people opt into functional, secure contact alerts, it could stop the virus, when implemented in addition to traditional contact tracing, testing, and responsive isolation.
            </p>
